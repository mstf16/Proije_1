...
private void Reverse() {
    ...
    class ReverseLettersOnlyApp {
        ...
        private static void runQuickSamples() {
            ...
            sample("İğne! ğüşöç 123", "çöşüğ !enğİ 123");
        ...
        private static void batchEdgeCases() {
            ...
            sample("zz", "zz");
            sample("Zz", "zZ");
            sample("Türkçe Karakterler: ç ğ ı i ö ş ü", "ü ş ö i ı ğ ç : r e l r e t k a r a K e ç k r ü T");
        }
